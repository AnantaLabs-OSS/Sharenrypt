...
export function Home() {
    ...
    React.useEffect(() => {
        const handleBackButton = async () => {
            ...
            else if (showConnectDialog) setShowConnectDialog(false);
            else if (showScanner) setShowScanner(false);
            else if (showQR) setShowQR(false);
            else {
                // If on root with no modals, exit app
                App.exitApp();
            }
        };
    ...
    }, [showChat, showSettings, showHistory, showConnectDialog, showScanner, showQR]);
